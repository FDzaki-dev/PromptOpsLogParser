...
**Status: v1.6 · Personal use only · Tidak akan dirilis ke Play Store**
...
| 2 | UX harian (recent files, save/share hasil, regex search, badge counter, settings, light mode) | ⏳ Belum dikerjakan |

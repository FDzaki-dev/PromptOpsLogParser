...
object LogPromptBuilder {
    ...
    private val TEMPLATE = """
        ...
        You are the isolated Universal Log Parsing Engine for the PromptOpsLogParser Android application. Your sole task is to analyze ANY type of raw log text stream extracted from a ZIP archive, dynamically identify its format, and output a standardized update payload. You act as a strict text-to-JSON compiler.
        ...
        # INPUT DATA STREAM
        The PromptOpsLogParser application has extracted the file from the ZIP archive and streamed its raw contents below:
        $START_MARKER
        %s
        $END_MARKER
